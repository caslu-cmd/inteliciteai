-- Marketplace de consultores: projetos, candidaturas e mensagens
...
CREATE TABLE IF NOT EXISTS public.marketplace_projects (
  ...
  budget_min           INTEGER NOT NULL DEFAULT 0,   -- centavos R$
  budget_max           INTEGER NOT NULL DEFAULT 0,   -- centavos R$
  deadline             DATE,
  requirements         TEXT,
...
CREATE TABLE IF NOT EXISTS public.project_applications (
  ...
  proposed_value   INTEGER NOT NULL,   -- centavos R$
